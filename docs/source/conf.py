...
try:
    from ibm_botocore.docs.translator import BotoHTML5Translator
    CUSTOM_HTML_TRANSLATOR = BotoHTML5Translator
except ImportError:
    CUSTOM_HTML_TRANSLATOR = None

session = ibm_boto3.session.Session(region_name='us-east-1')
...
version = ibm_boto3.__version__
# The full version, including alpha/beta/rc tags.
release = ibm_boto3.__version__
